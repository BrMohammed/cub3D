...
FILES = src/get_next_line.c src/drawlines/draw_lines.c src/drawlines/v3.c\
		...
		src/movement.c src/rander_image.c src/initialization.c src/initialization2.c src/mouse_fun.c src/colesion_of_ray/x_colesion.c src/colesion_of_ray/y_colesion.c\
